...
export default function IntelPage() {
  ...
  return (
    <div>
      ...
      <IntelTeamsNotice
        show={!teamsLoading && Boolean(teamsError || teamsData?.error || teams.length === 0)}
        message={teamsData?.error}
        onRetry={() => void reloadTeams()}
      />

      <IntelContent isLoading={isLoading} error={error} data={data} color={color} onRetry={() => void mutate()} />
    </div>
  );
}
