  ...
  return (
    <ConsolePanel className="xl:col-span-2">
      ...
      <div className="grid grid-cols-2 gap-6 p-4 md:grid-cols-4">
        ...
        <StatBlock label="Validated" value={String(accuracy?.races_evaluated ?? 0)} detail="prediction/result pairs available" />
  ...
  return (
    <ConsolePanel>
      <ConsoleHeader
        ...
        right={<StatusPill color={reviewColor(Boolean(review?.winner_correct), Boolean(review?.evaluated))}>{reviewBadgeLabel(review, accuracy?.races_evaluated ?? 0)}</StatusPill>}
      />
      {review?.evaluated
